...
Clicking the button "Characters" you can see the cards of characters, featured in Star wars films. In each character's card you can see the list of films each one featured in.
...
Clicking the button "Films" you can go back to the films page and observe the cards of Star Wars films. In each film's card you can find the list of characters featured in it.
